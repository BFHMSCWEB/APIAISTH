...
print (Fore.CYAN + "WEBSITE: https://bio.link/bfhmscweb")
print (Fore.BLUE + "SPAM SMS API AIS")
numbers = input("66:")
num = int(input("1-9999:"))
...
class SMS():
    def spamais(self,num):
        ...
        init()
        print(Fore.BLUE + "ATTACK.. : " + Fore.YELLO + str(random.randint(1,100)))
t = SMS()
def loop(num):
    for i in range(num):
        t.spamais(numbers)
